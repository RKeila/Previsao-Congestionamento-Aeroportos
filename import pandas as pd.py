...
def coletar_dados_opensky(inicio, fim):
    ...
    params = {
        'begin': inicio,  # Timestamp do início (em segundos desde 1970)
...
if dados_voos is not None:
    ...
    # Análise inicial
    print(dados_voos.head())          # Primeiras linhas do DataFrame
    print(dados_voos.describe())      # Estatísticas descritivas
